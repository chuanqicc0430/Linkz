...
public class StringUtils {
	...
	private static final String BLANK_SPACE = "\\s*|\\t*|\\r*|\\n*|";
	...
	public static boolean extractQuoted(String s, char quotaOpen, char quotaClose, Outter<String> quotedValue, Outter<String> first, Outter<String> left) {
	...
	public static String trimAll(String str) {
		return str.replaceAll(BLANK_SPACE, "");
	}
	...
	/**
	 * 将一个字符串进行标准化处理。 1、如果str是null，则设置成空串 2、如果str包含左右空格，则去掉。
	 * 
	...
	/**
	 * 字符串截取，超出加“...”，要尽可能不浪费长度 <param name="StrSource">原串</param> <param name="blackLength">截取长度</param> <returns>截取结果</returns>
	 */
