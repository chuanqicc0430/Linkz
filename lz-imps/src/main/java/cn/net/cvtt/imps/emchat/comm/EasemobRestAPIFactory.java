...
import cn.net.cvtt.imps.emchat.api.RestAPIInvoker;
import cn.net.cvtt.imps.emchat.comm.invoker.HttpClientRestAPIInvoker;
import cn.net.cvtt.imps.emchat.comm.invoker.JerseyRestAPIInvoker;
...
public class EasemobRestAPIFactory {
	...
	private static final String BASE_PACKAGE = "cn.net.cvtt.imps.emchat.api.impl";
