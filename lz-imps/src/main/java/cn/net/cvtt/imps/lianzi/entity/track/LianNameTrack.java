...
public class LianNameTrack {
	...
	public void buildLianNameTrack(DataRow row) throws SQLException {
		this.id = row.getLong("Id");
		this.lianId = row.getLong("LianId");
		this.orgId = row.getLong("OrgId");
		this.lianName = row.getString("LianName");
	...
	public String toString() {
		...
		builder.append("TRACK_LianName [id=");
		builder.append(id);
