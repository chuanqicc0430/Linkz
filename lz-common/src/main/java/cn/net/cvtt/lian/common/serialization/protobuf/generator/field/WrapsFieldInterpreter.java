...
public abstract class WrapsFieldInterpreter extends AbstractFieldInterpreter {
	 ...
	 * <code>if(data.getName() != null) size += cn.net.cvtt.lian.common.serialization.protobuf.CodedOutputStream.computeStringSize(1,data.getName());</code>
	 * <br>
	 * 的输出
	 */
	 ...
	 * <code>size += cn.net.cvtt.lian.common.serialization.protobuf.CodedOutputStream.computeStringSize(1,value);</code>
	 * <br>
	 * 的输出
	 */
